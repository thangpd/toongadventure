...
include 'setsail-instagram-helper.php';

/**
 * Class SetSailInstagramApi
 */
class SetSailInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var SetSailInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var SetSailInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'setsail_instagram_code';
	const USER_ID_OPTION_NAME = 'setsail_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'setsail_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'setsail_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->helper       = new SetSailInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see SetSailInstagramApi::buildCurrentPageURI()
	 */
	 ...
	 *
	 * @see SetSailInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see SetSailInstagramApi::getAccessToken()
	 */
