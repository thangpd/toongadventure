...
/**
 * Class SetSailInstagramHelper
 */
class SetSailInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines setsail_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'setsail_instagram_image_atts',
			array(
				'class'  => $imageSize,
