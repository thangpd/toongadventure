<?php
namespace SetSailCore\CPT\Shortcodes\Tabs;
...
class Tabs implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Tabs', 'setsail-core' ),
					'base'            => $this->getBase(),
					...
					'params'          => array(
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Standard', 'setsail-core' ) => 'standard',
	...
	public function render( $atts, $content = null ) {
		...
		$output = setsail_core_get_shortcode_module_template_part( 'templates/tab-template', 'tabs', '', $params );
