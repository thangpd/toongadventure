<?php
namespace SetSailCore\CPT\Shortcodes\SingleImage;
...
class SingleImage implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Single Image', 'setsail-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Moving on Hover', 'setsail-core' )  => 'moving'
							)
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = setsail_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
