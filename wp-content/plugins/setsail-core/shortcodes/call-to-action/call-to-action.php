<?php
namespace SetSailCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'setsail-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Normal', 'setsail-core' ) => 'normal',
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'setsail-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'setsail-core' ),
							'value'      => array(
								esc_html__( '80/20', 'setsail-core' ) => '80',
								esc_html__( '75/25', 'setsail-core' ) => '75',
								esc_html__( '66/33', 'setsail-core' ) => '66',
								esc_html__( '50/50', 'setsail-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Text', 'setsail-core' ),
							'value'       => esc_html__( 'Button Text', 'setsail-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'button_top_margin',
							'heading'    => esc_html__( 'Button Top Margin (px)', 'setsail-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'setsail-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_type',
							'heading'     => esc_html__( 'Button Type', 'setsail-core' ),
							'value'       => array(
								esc_html__( 'Solid', 'setsail-core' )   => 'solid',
								esc_html__( 'Outline', 'setsail-core' ) => 'outline'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Button Style', 'setsail-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'setsail-core' ),
							'value'       => array(
								esc_html__( 'Default', 'setsail-core' ) => '',
								esc_html__( 'Small', 'setsail-core' )   => 'small',
								esc_html__( 'Medium', 'setsail-core' )  => 'medium',
								esc_html__( 'Large', 'setsail-core' )   => 'large'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link', 'setsail-core' ),
							'group'      => esc_html__( 'Button Style', 'setsail-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'button_target',
							'heading'    => esc_html__( 'Button Link Target', 'setsail-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'setsail-core' ),
							'group'      => esc_html__( 'Button Style', 'setsail-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'setsail-core' ),
							'group'      => esc_html__( 'Button Style', 'setsail-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'setsail-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'setsail-core' ),
							'group'      => esc_html__( 'Button Style', 'setsail-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'setsail-core' ),
							'group'      => esc_html__( 'Button Style', 'setsail-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'setsail-core' ),
							'group'      => esc_html__( 'Button Style', 'setsail-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'setsail-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'setsail-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = setsail_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . setsail_select_filter_px( $params['button_top_margin'] ) . 'px';
		}
