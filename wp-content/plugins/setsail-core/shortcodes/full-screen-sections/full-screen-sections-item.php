...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'setsail-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'setsail-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'setsail-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'setsail-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'setsail-core' )   => 'cover',
								esc_html__( 'Contain', 'setsail-core' ) => 'contain',
								esc_html__( 'Inherit', 'setsail-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'setsail-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'setsail-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'setsail-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'setsail-core' ),
							'value'       => array(
								esc_html__( 'Default', 'setsail-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'setsail-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'setsail-core' ),
							'value'       => array(
								esc_html__( 'Default', 'setsail-core' ) => '',
								esc_html__( 'Light', 'setsail-core' )   => 'light',
								esc_html__( 'Dark', 'setsail-core' )    => 'dark'
							),
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'setsail-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'setsail-core'),
							'group'       => esc_html__('Responsiveness', 'setsail-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'setsail-core'),
							'group'       => esc_html__('Responsiveness', 'setsail-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'setsail-core'),
							'group'       => esc_html__('Responsiveness', 'setsail-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'setsail-core'),
							'group'       => esc_html__('Responsiveness', 'setsail-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = setsail_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
