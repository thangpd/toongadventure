...
class ImageGallery implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'setsail-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'setsail-core' ),
							'value'       => array_flip( setsail_select_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = setsail_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
