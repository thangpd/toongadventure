<?php
namespace SetSailCore\CPT\Shortcodes\Itemiconlist;

use SetSailCore\Lib;

class Itemiconlist implements Lib\ShortcodeInterface {
	private $base;
	
	function __construct() {
		$this->base = 'qodef_itemiconlist';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Itemiconlist', 'setsail-core' ),
					'base'                    => $this->base,
					'content_element'         => true,
					'category'                => esc_html__( 'by SETSAIL', 'setsail-core' ),
					'icon'                    => 'icon-wpb-itemiconlist extended-custom-icon',
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Itemiconlist', 'setsail-core' ) => 'itemiconlist',
	...
	public function render( $atts, $content = null ) {
		...
		$output = setsail_core_get_shortcode_module_template_part( 'templates/itemiconlist-holder-template', 'itemiconlist', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holder_classes[] = $params['style'] == 'toggle' ? 'qodef-toggle' : 'qodef-itemiconlist';
