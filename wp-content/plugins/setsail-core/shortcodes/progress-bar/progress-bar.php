<?php
namespace SetSailCore\CPT\Shortcodes\ProgressBar;
...
class ProgressBar implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Progress Bar', 'setsail-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'percent',
							'heading'    => esc_html__( 'Percentage', 'setsail-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'percentage_type',
							'heading'    => esc_html__( 'Percentage Type', 'setsail-core' ),
							'value'      => array(
								esc_html__( 'Default', 'setsail-core' )  => '',
								esc_html__( 'Floating', 'setsail-core' ) => 'floating'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Active Color', 'setsail-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color_inactive',
							'heading'    => esc_html__( 'Inactive Color', 'setsail-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = setsail_core_get_shortcode_module_template_part( 'templates/progress-bar-template', 'progress-bar', '', $params );
