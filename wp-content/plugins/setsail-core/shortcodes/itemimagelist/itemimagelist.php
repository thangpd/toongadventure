<?php
namespace SetSailCore\CPT\Shortcodes\Itemimagelist;

use SetSailCore\Lib;

class Itemimagelist implements Lib\ShortcodeInterface {
	private $base;
	
	function __construct() {
		$this->base = 'qodef_itemimagelist';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Itemimagelist', 'setsail-core' ),
					'base'                    => $this->base,
					'content_element'         => true,
					'category'                => esc_html__( 'by SETSAIL', 'setsail-core' ),
					'icon'                    => 'icon-wpb-itemimagelist extended-custom-icon',
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Itemimagelist', 'setsail-core' ) => 'itemimagelist',
	...
	public function render( $atts, $content = null ) {
		...
		$output = setsail_core_get_shortcode_module_template_part( 'templates/itemimagelist-holder-template', 'itemimagelist', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holder_classes[] = $params['style'] == 'toggle' ? 'qodef-toggle' : 'qodef-itemimagelist';
