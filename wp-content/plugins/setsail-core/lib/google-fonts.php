<?php
if ( ! function_exists( 'setsail_select_init_google_fonts_array' ) ) {
    function setsail_select_init_google_fonts_array() {
        ...
        $setsail_select_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'setsail_select_init_google_fonts_array');
}