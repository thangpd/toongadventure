...
$row_content_width = $anchor = $content_text_aligment = $row_has_shadow = $simple_background_color = $simple_background_image = $background_image_position = $disable_background_image = $parallax_background_image = $parallax_bg_speed = $parallax_bg_height = '';
...
if ( $row_content_width !== 'grid' ) {
	...
	if ( $row_has_shadow === 'yes' ) {
		$css_classes[] = 'qodef-row-has-shadow';
	}
	...
	if ( $row_has_shadow === 'yes' ) {
		$grid_row_class[] = 'qodef-row-has-shadow';
	}
}
...
if ( $row_content_width === 'grid' ) {
	$qodef_row_wrapper_start .= '<div class="qodef-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . esc_attr( $grid_row_datas ) . ' ' . setsail_select_get_inline_style( $qodef_grid_row_styles ) . '><div class="qodef-row-grid-section">';
	$qodef_row_wrapper_end   .= '</div></div>';
}

$qodef_after_wrapper_open   = apply_filters('setsail_select_filter_vc_after_wrapper_open', '', $atts);
$qodef_before_wrapper_close = apply_filters('setsail_select_filter_vc_before_wrapper_close', '', $atts);
$css_classes                = apply_filters('setsail_select_filter_vc_css_classes', $css_classes, $atts);
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . setsail_select_get_inline_style( $qodef_vc_row_styles ) . '>';
...
echo setsail_select_get_module_part( $output );
