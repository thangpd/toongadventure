...
$row_content_width = $content_text_aligment = $row_has_shadow = $simple_background_color = $simple_background_image = $background_image_position = $disable_background_image = '';
...
if ( $row_content_width === 'grid' ) {
	$qodef_row_wrapper_start .= '<div class="qodef-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . setsail_select_get_inline_style( $qodef_grid_row_styles ) . '><div class="qodef-row-grid-section">';
