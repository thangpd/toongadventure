...
/*
   Class: SetSailSelectClassFramework
...
class SetSailSelectClassFramework {
	...
	private function __construct() {
		$this->qodeOptions         = SetSailSelectClassOptions::get_instance();
		$this->qodeMetaBoxes       = SetSailSelectClassMetaBoxes::get_instance();
		$this->qodeTaxonomyOptions = SetSailSelectClassTaxonomyOptions::get_instance();
		$this->qodeUserOptions     = SetSailSelectClassUserOptions::get_instance();
		$this->qodeDashboardOptions = SetSailSelectClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( SetSailSelectClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class SetSailSelectClassSkinManager
 *
...
class SetSailSelectClassSkinManager {
	...
	/**
	 * @see SetSailSelectClassSkinManager::setSkin()
	 */
	...
	private function setSkin( $skinName = SELECT_PROFILE_SLUG ) {
		if ( $skinName !== '' ) {
			if ( file_exists( get_template_directory() . '/framework/admin/skins/' . $skinName . '/skin.php' ) ) {
				...
				$skinName = ucfirst( $skinName ) . esc_html__( 'Skin', 'setsail' );
...
/**
 * Class SetSailSelectClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class SetSailSelectClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( setsail_select_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.qodeSCIcon = '<?php echo setsail_select_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.qodeSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'setsail' ) ?>';
		</script>
	<?php }
...
/*
   Class: SetSailSelectClassOptions
...
class SetSailSelectClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $setsail_select_global_options ) ) {
			return $setsail_select_global_options[ $key ];
...
/*
   Class: SetSailSelectClassAdminPage
   A class that initializes Select Admin Page
*/
class SetSailSelectClassAdminPage implements iSetSailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title_label = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new SetSailSelectClassFieldFactory();
		$this->slug    = $slug;
	...
	public function renderChild( iSetSailSelectInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: SetSailSelectClassMetaBoxes
...
/*
   Class: SetSailSelectClassMetaBox
   A class that initializes Select Meta Box
*/
class SetSailSelectClassMetaBox implements iSetSailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $setsail_select_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: SetSailSelectClassTaxonomyOptions
   A class that initializes SetSailSelectClass Taxonomy Options
*/
class SetSailSelectClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: SetSailSelectClassTaxonomyOption
   A class that initializes SetSailSelectClass Taxonomy Option
*/
class SetSailSelectClassTaxonomyOption implements iSetSailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new SetSailSelectClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: SetSailSelectClassUserOptions
   A class that initializes SetSailSelectClass User Options
*/
class SetSailSelectClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: SetSailSelectClassUserOption
   A class that initializes SetSailSelectClass User Option
*/
class SetSailSelectClassUserOption implements iSetSailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new SetSailSelectClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: SetSailSelectClassDashboardOptions
   A class that initializes SetSailSelectClass Dashboard Options
*/
class SetSailSelectClassDashboardOptions {
	private static $instance;
...
/*
   Class: SetSailSelectClassDashboardOption
   A class that initializes SetSailSelectClass Dashboard Option
*/
class SetSailSelectClassDashboardOption implements iSetSailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new SetSailSelectClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'setsail_select_init_framework_variable' ) ) {
	function setsail_select_init_framework_variable() {
		global $setsail_select_global_Framework;
		
		$setsail_select_global_Framework = SetSailSelectClassFramework::get_instance();
		$qodeSkinManager                 = new SetSailSelectClassSkinManager();
		$setsail_select_global_Framework->setSkin( $qodeSkinManager->getSkin() );
	}
	
	add_action( 'setsail_select_action_before_options_map', 'setsail_select_init_framework_variable' );
}
?>