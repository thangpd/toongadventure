...
if ( ! function_exists( 'setsail_select_add_ion_icon_pack' ) ) {
	function setsail_select_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new SetSailSelectClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_collection', 'setsail_select_add_ion_icon_pack' );
}

if ( ! function_exists( 'setsail_select_add_ion_icon_pack_option' ) ) {
	function setsail_select_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'setsail' );
		
		return $options;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_options', 'setsail_select_add_ion_icon_pack_option' );
	add_filter( 'setsail_select_filter_add_icon_pack_into_social_options', 'setsail_select_add_ion_icon_pack_option' );
}

class SetSailSelectClassIonIcons implements iSetSailSelectInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
