...
if ( ! function_exists( 'setsail_select_add_linea_icon_pack' ) ) {
	function setsail_select_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new SetSailSelectClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_collection', 'setsail_select_add_linea_icon_pack' );
}

if ( ! function_exists( 'setsail_select_add_linea_icon_pack_option' ) ) {
	function setsail_select_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'setsail' );
		
		return $options;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_options', 'setsail_select_add_linea_icon_pack_option' );
}

class SetSailSelectClassLineaIcons implements iSetSailSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
