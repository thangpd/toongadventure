...
if ( ! function_exists( 'setsail_select_add_dripicons_icon_pack' ) ) {
	function setsail_select_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new SetSailSelectClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_collection', 'setsail_select_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'setsail_select_add_dripicons_icon_pack_option' ) ) {
	function setsail_select_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'setsail' );
		
		return $options;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_options', 'setsail_select_add_dripicons_icon_pack_option' );
}

class SetSailSelectClassDripicons implements iSetSailSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
