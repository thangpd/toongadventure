...
if ( ! function_exists( 'setsail_select_add_linear_icon_pack' ) ) {
	function setsail_select_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new SetSailSelectClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_collection', 'setsail_select_add_linear_icon_pack' );
}

if ( ! function_exists( 'setsail_select_add_linear_icon_pack_option' ) ) {
	function setsail_select_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'setsail' );
		
		return $options;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_options', 'setsail_select_add_linear_icon_pack_option' );
}

class SetSailSelectClassLinearIcons implements iSetSailSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
