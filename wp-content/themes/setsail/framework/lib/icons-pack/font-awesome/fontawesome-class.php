...
if ( ! function_exists( 'setsail_select_add_font_awesome_icon_pack' ) ) {
	function setsail_select_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new SetSailSelectClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_collection', 'setsail_select_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'setsail_select_add_font_awesome_icon_pack_option' ) ) {
	function setsail_select_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'setsail' );
		
		return $options;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_options', 'setsail_select_add_font_awesome_icon_pack_option' );
	add_filter( 'setsail_select_filter_add_icon_pack_into_social_options', 'setsail_select_add_font_awesome_icon_pack_option' );
}

class SetSailSelectClassIconsFontAwesome implements iSetSailSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
