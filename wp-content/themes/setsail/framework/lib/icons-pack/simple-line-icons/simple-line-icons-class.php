...
if ( ! function_exists( 'setsail_select_add_simple_line_icon_pack' ) ) {
	function setsail_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new SetSailSelectClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_collection', 'setsail_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'setsail_select_add_simple_line_icon_pack_option' ) ) {
	function setsail_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'setsail' );
		
		return $options;
	}
	
	add_filter( 'setsail_select_filter_add_icon_pack_into_options', 'setsail_select_add_simple_line_icon_pack_option' );
	add_filter( 'setsail_select_filter_add_icon_pack_into_social_options', 'setsail_select_add_simple_line_icon_pack_option' );
}

class SetSailSelectClassSimpleLineIcons implements iSetSailSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'setsail'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'setsail'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'setsail'),
            'icon-social-facebook'    => esc_html__('Facebook', 'setsail'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'setsail'),
            'icon-social-github'      => esc_html__('Github', 'setsail'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'setsail'),
            'icon-social-instagram'   => esc_html__('Instagram', 'setsail'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'setsail'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'setsail'),
            'icon-social-reddit'      => esc_html__('Reddit', 'setsail'),
            'icon-social-skype'       => esc_html__('Skype', 'setsail'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'setsail'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'setsail'),
            'icon-social-spotify'     => esc_html__('Spotify', 'setsail'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'setsail'),
            'icon-social-twitter'     => esc_html__('Twitter', 'setsail'),
            'icon-social-youtube'     => esc_html__('Youtube', 'setsail')
        );
    }
