...
/*
   Class: SetSailSelectClassDashboardForm
   A class that initializes Select Dashboard Container
*/

class SetSailSelectClassDashboardForm implements iSetSailSelectInterfaceLayoutNode, iSetSailSelectInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: SetSailSelectClassDashboardGroup
   A class that initializes SetSailSelectClass Group Field
*/
class SetSailSelectClassDashboardGroup implements iSetSailSelectInterfaceLayoutNode, iSetSailSelectInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: SetSailSelectClassDashboardTitle
   A class that initializes Dashboard Title
*/
class SetSailSelectClassDashboardTitle implements iSetSailSelectInterfaceRender {
	private $name;
	private $title;
	private $args = array();
...
/*
   Class: SetSailSelectClassDashboardField
   A class that initializes SetSailSelectClass Front Field
*/
class SetSailSelectClassDashboardField implements iSetSailSelectInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class SetSailSelectClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class SetSailSelectClassDashboardFieldText extends SetSailSelectClassDashboardFieldType {
			...
			<div class="qodef-dashboard-field-row">
				<div class="qodef-dashboard-item col-lg-<?php echo esc_attr( $col_width ); ?>">
					<div class="qodef-dashboard-input-holder">
						<input class="qodef-dashboard-input" type="<?php echo esc_attr( $input_type ); ?>" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $id ); ?>" value="<?php echo esc_attr( htmlspecialchars( $value ) ); ?>" placeholder="<?php echo esc_attr( $label ); ?>">
						<?php if ( $description !== '' ) { ?>
...
class SetSailSelectClassDashboardFieldTextArea extends SetSailSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class SetSailSelectClassDashboardFieldImage extends SetSailSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
			...
			<div class="qodef-dashboard-gallery-holder">
				<ul class="qodef-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
						echo setsail_select_get_module_part( $value_html );
					} ?>
				</ul>
				<div class="qodef-dashboard-gallery-uploader">
					...
					if ( setsail_membership_theme_installed() ) {
						echo setsail_select_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'setsail' ),
							'custom_class' => 'qodef-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="qodef-btn qodef-btn-medium qodef-btn-solid qodef-dashboard-gallery-upload"><span class="qodef-btn-text">' . esc_html__( 'Upload', 'setsail' ) . '</span></a>';
					} ?>
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
						<button class="qodef-btn qodef-btn-solid qodef-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'setsail' ); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class SetSailSelectClassDashboardFieldGallery extends SetSailSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class SetSailSelectClassDashboardFieldSelect extends SetSailSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class SetSailSelectClassDashboardFieldDate extends SetSailSelectClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class SetSailSelectClassDashboardFieldIcon extends SetSailSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
...
class SetSailSelectClassDashboardFieldColor extends SetSailSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class SetSailSelectClassDashboardFieldCheckBoxGroup extends SetSailSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class SetSailSelectClassDashboardFieldAddress extends SetSailSelectClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class SetSailSelectClassDashboardRepeater implements iSetSailSelectInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ( $this->table_layout ) { ?>
				<div class="qodef-dashboard-repeater-table-heading">
					<div class="qodef-dashboard-repeater-fields-holder">
						<div class="qodef-dashboard-repeater-table-cell qodef-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'setsail' ) ?></div>
						...
						<div class="qodef-dashboard-repeater-table-cell qodef-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'setsail' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class SetSailSelectClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new SetSailSelectClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'textarea':
				$field = new SetSailSelectClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'date':
				$field = new SetSailSelectClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new SetSailSelectClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'gallery':
				$field = new SetSailSelectClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new SetSailSelectClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new SetSailSelectClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new SetSailSelectClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'checkboxgroup':
				$field = new SetSailSelectClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'address':
				$field = new SetSailSelectClassDashboardFieldAddress();
