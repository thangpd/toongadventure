...
/**
 * Class that represents Header Rightleft layout and option
 *
 * Class HeaderRightleft
 */
class HeaderRightleft extends HeaderType
{
    ...
    public function loadTemplate($parameters = array())
    {
        ...
        $menu_area_position                     = setsail_select_get_meta_field_intersect('set_menu_area_position',
            $page_id);
        ...
        $parameters = apply_filters('setsail_select_filter_header_rightleft_parameters', $parameters);

        setsail_select_get_module_template_part('templates/' . $this->slug, $this->moduleName . '/types/' . $this->slug,
            '', $parameters);
    }
    ...
    public function calculateHeightOfTransparency()
    {
        ...
        $menu_background_transparency      = setsail_select_get_meta_field_intersect('menu_area_background_transparency',
            $id);
