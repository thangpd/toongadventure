...
class HeaderVertical extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		$parameters['holder_class'] = setsail_select_vertical_header_holder_class();
		
		$parameters = apply_filters( 'setsail_select_filter_header_vertical_parameters', $parameters );
