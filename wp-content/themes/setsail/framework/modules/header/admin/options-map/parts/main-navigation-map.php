...
if ( ! function_exists( 'setsail_select_get_hide_dep_for_header_main_menu_options' ) ) {
	function setsail_select_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'setsail_select_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'setsail_select_header_main_navigation_options_map' ) ) {
	function setsail_select_header_main_navigation_options_map() {
		$hide_dep_options = setsail_select_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = setsail_select_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'setsail' ),
		...
		setsail_select_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'setsail' )
			)
		);
		...
		$drop_down_group = setsail_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'setsail' )
			)
		);
		
		$drop_down_row1 = setsail_select_add_admin_row(
			array(
		...
		setsail_select_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'setsail' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'setsail' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'setsail' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'setsail' )
				)
			)
		);
		...
		$first_level_group = setsail_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'setsail' )
			)
		);
		...
		setsail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'setsail' ),
			)
		);
		...
		setsail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'setsail' ),
			)
		);
		
		$first_level_row4 = setsail_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		setsail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'setsail' ),
			)
		);
		...
		setsail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'setsail' ),
			)
		);
		
		$first_level_row5 = setsail_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = setsail_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = setsail_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		setsail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'setsail' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		setsail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'setsail' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = setsail_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'setsail' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'setsail' )
			)
		);
		...
		$second_level_wide_group = setsail_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'setsail' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'setsail' )
			)
		);
		
		$second_level_wide_row1 = setsail_select_add_admin_row(
			array(
		...
		$second_level_wide_row2 = setsail_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = setsail_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = setsail_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'setsail' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'setsail' )
			)
		);
		...
		$third_level_wide_group = setsail_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'setsail' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'setsail' )
			)
		);
		
		$third_level_wide_row1 = setsail_select_add_admin_row(
			array(
		...
		$third_level_wide_row2 = setsail_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = setsail_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'setsail_select_action_header_main_navigation_options_map', 'setsail_select_header_main_navigation_options_map', 10, 1 );
}