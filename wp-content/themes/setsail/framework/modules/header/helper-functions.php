...
$setsail_menus = array(
    ...
    'left-nav'  => array(
        'depth'          => 4,
        'container'      => 'ul',
        'menu_class'     => 'nav navbar-nav setsail-menu-wrapper',
...
if ( ! function_exists('setsail_theme_nav_menu')) :
    /**
...
if ( ! function_exists('setsail_get_regist_menu')) {

    function setsail_get_regist_menu()
    {
...
if ( ! function_exists('setsail_select_header_class')) {
    ...
    function setsail_select_header_class($classes)
    {
        ...
        $disable_menu_area_grid_shadow = setsail_select_get_meta_field_intersect('menu_area_in_grid_shadow',
                $id) == 'no';
        ...
        $disable_menu_area_grid_border = setsail_select_get_meta_field_intersect('menu_area_in_grid_border',
                $id) == 'no';
        ...
        $disable_logo_area_grid_border = setsail_select_get_meta_field_intersect('logo_area_in_grid_border',
                $id) == 'no';
...
if ( ! function_exists('setsail_select_header_area_style')) {
    ...
    function setsail_select_header_area_style($style)
    {
        ...
        $menu_area_background_transparency = get_post_meta($page_id, 'qodef_menu_area_background_transparency_meta',
            true);
        ...
        $menu_area_background_color_rgba = setsail_select_rgba_color($menu_area_background_color,
        ...
        if ($container_side_padding !== '') {
            if (setsail_select_string_ends_with($container_side_padding,
                    'px') || setsail_select_string_ends_with($container_side_padding, '%')) {
        ...
        $menu_area_grid_background_color        = get_post_meta($page_id, 'qodef_menu_area_grid_background_color_meta',
            true);
        $menu_area_grid_background_transparency = get_post_meta($page_id,
            'qodef_menu_area_grid_background_transparency_meta', true);

        if ($menu_area_grid_background_transparency === '') {
            $menu_area_grid_background_transparency = 1;
        }

        $menu_area_grid_background_color_rgba = setsail_select_rgba_color($menu_area_grid_background_color,
        ...
        $logo_area_background_transparency = get_post_meta($page_id, 'qodef_logo_area_background_transparency_meta',
            true);
        ...
        $logo_area_background_color_rgba = setsail_select_rgba_color($logo_area_background_color,
            $logo_area_background_transparency);
        ...
        $logo_area_grid_background_color        = get_post_meta($page_id, 'qodef_logo_area_grid_background_color_meta',
            true);
        $logo_area_grid_background_transparency = get_post_meta($page_id,
            'qodef_logo_area_grid_background_transparency_meta', true);

        if ($logo_area_grid_background_transparency === '') {
            $logo_area_grid_background_transparency = 1;
        }

        $logo_area_grid_background_color_rgba = setsail_select_rgba_color($logo_area_grid_background_color,
            $logo_area_grid_background_transparency);
        ...
        $current_style = apply_filters('setsail_select_filter_add_header_page_custom_style', $current_style,
                $class_prefix, $page_id) . $style;
