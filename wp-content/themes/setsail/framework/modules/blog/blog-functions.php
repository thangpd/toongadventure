...
/**
 * FUNCTIONS LIST
 * @see setsail_select_include_blog_helper_functions
 * @see setsail_select_get_archive_blog_list_layout
 * @see setsail_select_get_holder_params_blog
 * @see setsail_select_get_blog
 * @see setsail_select_get_blog_type
 * @see setsail_select_get_blog_query
 * @see setsail_select_get_blog_list_holder_classes
 * @see setsail_select_get_blog_holder_data_params
 * @see setsail_select_set_ajax_url
 * @see setsail_select_blog_load_more
 * @see setsail_select_get_post_format_html
 * @see setsail_select_single_link_pages
 * @see setsail_select_get_blog_single
 * @see setsail_select_get_blog_single_type
 * @see setsail_select_get_single_post_format_html
 * @see setsail_select_excerpt
 * @see setsail_select_excerpt_length
 * @see setsail_select_post_has_read_more
 * @see setsail_select_modify_read_more_link
 * @see setsail_select_get_blog_related_post_type
 * @see setsail_select_get_blog_related_posts
 * @see setsail_select_blog_shortcode_load_more
 * @see setsail_select_get_user_custom_fields
 * @see setsail_select_blog_item_has_link
 * @see setsail_select_get_blog_module
...
if ( ! function_exists( 'setsail_select_include_blog_helper_functions' ) ) {
	 ...
	 */
	function setsail_select_include_blog_helper_functions( $module, $type ) {
		include_once SELECT_FRAMEWORK_MODULES_ROOT_DIR . '/blog/templates/' . $module . '/' . $type . '/helper.php';
	}
}

if ( ! function_exists( 'setsail_select_include_blog_types_function_file' ) ) {
	/**
	 * Function which include blog type function file
	 */
	function setsail_select_include_blog_types_function_file() {
...
if ( ! function_exists( 'setsail_select_register_blog_template' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_register_blog_template_path' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_get_archive_blog_list_layout' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_get_holder_params_blog' ) ) {
	/**
	 * Function which return holder class and holder inner class for blog pages
	 */
	function setsail_select_get_holder_params_blog() {
		/**
		 * Available parameters for holder params
		 * -holder
		 * -inner
		 */
		return apply_filters( 'setsail_select_filter_blog_holder_params', $params = array() );
	}
}

if ( ! function_exists( 'setsail_select_get_blog' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_get_blog_type' ) ) {
	/**
	 * Function which create query for blog lists
	 *
	 * @param $type string with name of list that is loaded
	 */
	function setsail_select_get_blog_type( $type ) {
...
if ( ! function_exists( 'setsail_select_get_blog_query' ) ) {
	/**
	 * Function which create query for blog lists
	 *
...
if ( ! function_exists( 'setsail_select_get_max_number_of_pages' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_get_blog_list_holder_classes' ) ) {
	/**
	 ...
	 */
	function setsail_select_get_blog_list_holder_classes( $type ) {
		$blog_classes   = array();
...
if ( ! function_exists( 'setsail_select_get_blog_holder_data_params' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_blog_load_more' ) ) {
	function setsail_select_blog_load_more() {
		$params           = array();
		...
		if ( $query_results->have_posts() ):
			while ( $query_results->have_posts() ) : $query_results->the_post();
				$html .= setsail_select_get_post_format_html( $blog_type, 'yes', $params );
			endwhile;
		else:
...
if ( ! function_exists( 'setsail_select_get_post_format_html' ) ) {
	/**
	...
	function setsail_select_get_post_format_html( $type = "", $ajax = '', $ajax_params = array() ) {
		...
		*/
		...
		if ( $ajax == 'yes' ) {
			return setsail_select_get_blog_module_template_part( 'templates/lists/' . $type . '/post', $post_format, $params );
		}
	}
}

if ( ! function_exists( 'setsail_select_single_link_pages' ) ) {
	/**
	 * Function which return parts on single.php which are just below content
	 */
	function setsail_select_single_link_pages() {
		$args_pages = array(
			'before'      => '<div class="qodef-single-links-pages"><div class="qodef-single-links-pages-inner"><span class="qodef-single-links-label">' . esc_html__( 'Pages: ', 'setsail' ) . '</span>',
			'after'       => '</div></div>',
			'link_before' => '<span>',
			'link_after'  => '</span>',
			'pagelink'    => '%'
...
if ( ! function_exists( 'setsail_select_single_link_pages_exists' ) ) {
	/**
	 * Function which return string if single link page exists
	 */
	function setsail_select_single_link_pages_exists() {
		$args_pages = array(
			'echo' => 0
		);
...
if ( ! function_exists( 'setsail_select_get_blog_single' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_get_blog_single_type' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_get_single_post_format_html' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_excerpt' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_excerpt_length' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_post_has_read_more' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_modify_read_more_link' ) ) {
	/**
	 * Function that modifies read more link output.
	 * Hooks to the_content_more_link
	 * @return string modified output
	 */
	function setsail_select_modify_read_more_link() {
		$button_params = array(
...
if ( ! function_exists( 'setsail_select_get_blog_related_post_type' ) ) {
	/**
	 ...
	 * @return WP_Query
	 */
	function setsail_select_get_blog_related_post_type( $post_id, $options = array() ) {
...
if ( ! function_exists( 'setsail_select_get_blog_related_posts' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_blog_item_has_link' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_get_blog_module' ) ) {
	/**
...
if ( ! function_exists( 'setsail_select_return_post_format' ) ) {
	/**
	 * Function return all parts on single.php page
	 */
	function setsail_select_return_post_format() {
...
if ( ! function_exists( 'setsail_select_return_has_media' ) ) {
	/**
	 * Function return all parts on single.php page
	 *
...
if ( ! function_exists( 'setsail_select_blog_single_title' ) ) {
	/**
