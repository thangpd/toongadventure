<?php
namespace SetSailCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'setsail' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'setsail' )            => 'slider',
							esc_html__( 'Carousel', 'setsail' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'setsail' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
					...
					array(
						...
						'heading'     => esc_html__( 'Enable Post Info Author', 'setsail' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Enable Post Info Category', 'setsail' ),
						'value'       => array_flip( setsail_select_get_yes_no_select_array( false, true ) ),
						'save_always' => true,
						'group'       => esc_html__( 'Post Info', 'setsail' )
					),
					array(
						...
						'heading'     => esc_html__( 'Enable Post Info Comments', 'setsail' ),
	...
	public function render( $atts, $content = null ) {
		...
		setsail_select_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
