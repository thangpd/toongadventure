...
if ( class_exists('SetSailSelectClassWidget') ) {
	class SetSailSelectClassContactForm7Widget extends SetSailSelectClassWidget {
		public function __construct() {
			parent::__construct(
				'qodef_contact_form_7_widget',
				esc_html__('SetSail Contact Form 7 Widget', 'setsail'),
				array('description' => esc_html__('Add contact form 7 to widget areas', 'setsail'))
			);
		...
		protected function setParams() {
			...
			$this->params = array(
				array(
					'type'  => 'textfield',
					'name'  => 'extra_class',
					'title' => esc_html__('Extra Class Name', 'setsail')
				),
				array(
					'type'  => 'textfield',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form',
					'title'   => esc_html__('Select Contact Form 7', 'setsail'),
					'options' => $contact_forms
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form_style',
					'title'   => esc_html__('Contact Form 7 Style', 'setsail'),
					'options' => array(
		...
		public function widget($args, $instance) {
			...
			?>
            <div class="widget qodef-contact-form-7-widget <?php echo esc_attr($extra_class); ?>" <?php echo setsail_select_get_inline_style($widget_styles); ?>>
