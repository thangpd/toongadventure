...
if ( ! function_exists('setsail_select_footer_options_map')) {
    function setsail_select_footer_options_map()
    {
        ...
        setsail_select_add_admin_field(
            array(
                'name'   => 'footer_background_container',
                'type'   => 'image',
                'label'  => esc_html__('Background Container', 'setsail'),
                'parent' => $footer_panel,
            )
        );
        ...
        setsail_select_add_admin_field(
            array(
                ...
                'description'   => esc_html__('Enabling this option will make Footer gradually appear on scroll',
                    'setsail'),
                'parent'        => $footer_panel
            )
        );
    ...
    add_action('setsail_select_action_options_map', 'setsail_select_footer_options_map',
        setsail_select_set_options_map_position('footer'));
}