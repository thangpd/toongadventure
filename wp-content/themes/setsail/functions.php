...
if ( ! function_exists( 'setsail_select_styles' ) ) {
	...
	function setsail_select_styles() {
		...
		wp_enqueue_style( 'setsail-select-modules', SELECT_ASSETS_ROOT . '/css/modules.min.css', $modules_css_deps_array );
		...
		if ( setsail_select_dashboard_page() || setsail_select_has_dashboard_shortcodes() ) {
			wp_enqueue_style( 'setsail-select-dashboard', SELECT_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/qodef-dashboard.css' );
		}
		...
		if ( file_exists( SELECT_ROOT_DIR . '/assets/css/style_dynamic.css' ) && setsail_select_is_css_folder_writable() && ! is_multisite() ) {
			wp_enqueue_style( 'setsail-select-style-dynamic', SELECT_ASSETS_ROOT . '/css/style_dynamic.css', $style_dynamic_deps_array, filemtime( SELECT_ROOT_DIR . '/assets/css/style_dynamic.css' ) ); //it must be included after woocommerce styles so it can override it
		} else if ( file_exists( SELECT_ROOT_DIR . '/assets/css/style_dynamic_ms_id_' . setsail_select_get_multisite_blog_id() . '.css' ) && setsail_select_is_css_folder_writable() && is_multisite() ) {
			wp_enqueue_style( 'setsail-select-style-dynamic', SELECT_ASSETS_ROOT . '/css/style_dynamic_ms_id_' . setsail_select_get_multisite_blog_id() . '.css', $style_dynamic_deps_array, filemtime( SELECT_ROOT_DIR . '/assets/css/style_dynamic_ms_id_' . setsail_select_get_multisite_blog_id() . '.css' ) ); //it must be included after woocommerce styles so it can override it
		}
		
		//is responsive option turned on?
		if ( setsail_select_is_responsive_on() ) {
			wp_enqueue_style( 'setsail-select-modules-responsive', SELECT_ASSETS_ROOT . '/css/modules-responsive.min.css' );
			
			//is woocommerce installed?
			if ( setsail_select_is_woocommerce_installed() && setsail_select_load_woo_assets() ) {
				//include theme's woocommerce responsive styles
				wp_enqueue_style( 'setsail-select-woo-responsive', SELECT_ASSETS_ROOT . '/css/woocommerce-responsive.min.css' );
			}
			...
			if ( file_exists( SELECT_ROOT_DIR . '/assets/css/style_dynamic_responsive.css' ) && setsail_select_is_css_folder_writable() && ! is_multisite() ) {
				wp_enqueue_style( 'setsail-select-style-dynamic-responsive', SELECT_ASSETS_ROOT . '/css/style_dynamic_responsive.css', array(), filemtime( SELECT_ROOT_DIR . '/assets/css/style_dynamic_responsive.css' ) );
			} else if ( file_exists( SELECT_ROOT_DIR . '/assets/css/style_dynamic_responsive_ms_id_' . setsail_select_get_multisite_blog_id() . '.css' ) && setsail_select_is_css_folder_writable() && is_multisite() ) {
				wp_enqueue_style( 'setsail-select-style-dynamic-responsive', SELECT_ASSETS_ROOT . '/css/style_dynamic_responsive_ms_id_' . setsail_select_get_multisite_blog_id() . '.css', array(), filemtime( SELECT_ROOT_DIR . '/assets/css/style_dynamic_responsive_ms_id_' . setsail_select_get_multisite_blog_id() . '.css' ) );
			}
		}
	}
...
if ( ! function_exists( 'setsail_select_google_fonts_styles' ) ) {
	...
	function setsail_select_google_fonts_styles() {
		...
		if ( count( $fonts_array ) > 0 ) {
			...
			$setsail_select_global_fonts = add_query_arg( $fonts_full_list_args, $protocol . '//fonts.googleapis.com/css' );
			wp_enqueue_style( 'setsail-select-google-fonts', esc_url_raw( $setsail_select_global_fonts ), array(), '1.0.0' );
...
if ( ! function_exists( 'setsail_select_scripts' ) ) {
	...
	function setsail_select_scripts() {
        ...
        wp_enqueue_script( 'select2', SELECT_ASSETS_ROOT . '/js/modules/plugins/select2.min.js', array('jquery'), false, true );
		...
		if ( ! empty( $google_maps_api_key ) ) {
			wp_enqueue_script( 'setsail-select-google-map-api', '//maps.googleapis.com/maps/api/js?key=' . esc_attr( $google_maps_api_key ) . $google_maps_extensions, array(), false, true );
            if ( ! empty( $google_maps_extensions_array ) && is_array( $google_maps_extensions_array ) ) {
                wp_enqueue_script('geocomplete', SELECT_ASSETS_ROOT . '/js/modules/plugins/jquery.geocomplete.min.js', array('jquery', 'setsail-select-google-map-api'), false, true);
            }
		}

		wp_enqueue_script( 'setsail-select-modules', SELECT_ASSETS_ROOT . '/js/modules.min.js', array( 'jquery' ), false, true );
		...
		if ( setsail_select_dashboard_page() || setsail_select_has_dashboard_shortcodes() ) {
			...
			wp_enqueue_script( 'setsail-select-dashboard', SELECT_FRAMEWORK_ADMIN_ASSETS_ROOT . '/js/qodef-dashboard.js', $dash_array_deps, false, true );
...
if ( ! function_exists( 'setsail_select_enqueue_editor_customizer_styles' ) ) {
	...
	function setsail_select_enqueue_editor_customizer_styles() {
		wp_enqueue_style( 'setsail-style-handle-editor-customizer-styles', SELECT_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/editor-customizer-style.css' );
	}
...
if ( ! function_exists( 'setsail_select_enqueue_editor_customizer_blocks_styles' ) ) {
	...
	function setsail_select_enqueue_editor_customizer_blocks_styles() {
		wp_enqueue_style( 'setsail-style-handle-editor-customizer-blocks', SELECT_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/editor-customizer-blocks.css' );
	}
...
if ( ! function_exists( 'setsail_select_smooth_page_transitions' ) ) {
	...
	function setsail_select_smooth_page_transitions() {
		...
		if ( setsail_select_get_meta_field_intersect( 'smooth_page_transitions', $id ) === 'yes' && setsail_select_get_meta_field_intersect( 'page_transition_preloader', $id ) === 'yes' ) { ?>
